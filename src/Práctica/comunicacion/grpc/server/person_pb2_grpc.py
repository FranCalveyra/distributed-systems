...
class PersonServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetOldest = channel.stream_unary(
            "/communication.PersonService/GetOldest",
...
class PersonServiceServicer(object):
    ...
    def GetOldest(self, request_iterator, context):
        """Missing associated documentation comment in .proto file."""
...
def add_PersonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetOldest": grpc.stream_unary_rpc_method_handler(
            servicer.GetOldest,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "communication.PersonService", rpc_method_handlers
    )
